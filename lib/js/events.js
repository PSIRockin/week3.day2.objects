...
// 1) In "index.html", create an empty `div` with an id of "gridDiv" (What line though)
...
let allHeroContainers = document.getElementsByClassName("allHeroContainers")
